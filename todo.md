...
- when running e.g. daily-run, first show how many lausuntopyyntö were fetched, are new, and are going to be processed, then request confirmation (e.g., have the user input "Y") before starting.
